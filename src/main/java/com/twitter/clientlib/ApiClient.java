...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("UserToken", new TwitterApiKeyOAuth());
    ...
    public Request buildRequest(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
        List<Pair> paramsForAuth = new ArrayList<Pair>(queryParams);
        paramsForAuth.addAll(collectionQueryParams);

        updateParamsForAuth(path, method, authNames, paramsForAuth, headerParams, cookieParams);
     ...
     */
    public void updateParamsForAuth(String path, String method, String[] authNames, List<Pair> queryParams, Map<String, String> headerParams, Map<String, String> cookieParams) {
        for (String authName : authNames) {
            Authentication auth = authentications.get(authName);
            if (auth == null) {
                throw new RuntimeException("Authentication undefined: " + authName);
            }
            auth.applyToParams(path, method, queryParams, headerParams, cookieParams);
        }
    }
